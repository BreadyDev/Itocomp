...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      {
        messages
          .filter((message) => message.role === roleUser || message.role === roleSys)
          .map((message, index) => (
      ...
      <form id="TextA" className="flex justify-between py-3 px-3" onSubmit={handleSubmit}>
        <textarea value={input} onChange={changeInput} placeholder="Escribe aqui..." id="textArea-prompt" class="bg-transparent w-[95%] focus:outline-none"></textarea>
